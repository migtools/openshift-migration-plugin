...
WORKDIR /go/src/github.com/konveyor/openshift-migration-plugin
COPY . ./
...
RUN mkdir /plugins
COPY --from=builder /go/src/github.com/konveyor/openshift-migration-plugin/_output/$BIN /plugins/
USER nobody:nobody
