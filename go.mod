...
require (
	...
	github.com/konveyor/openshift-velero-plugin v0.0.0-20200617173822-2e85755d0e6b
	github.com/openshift/api v0.0.0-20190813152110-b5570061b31f
	github.com/openshift/client-go v0.0.0-20190813201236-5a5508328169
	github.com/openshift/library-go v0.0.0-20190813153448-1eb1131507bf // indirect
